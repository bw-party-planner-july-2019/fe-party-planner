        ...
        <Grid item xs={12} sm={6} md={4}>
          <Card className={classes.card}>
            ...
            <CardActions>
              ...
              <Dialog open={open} onClose={handleConfirm} aria-labelledby="confirm-delete-title"
                      aria-describedby="confirm-delete-description">
                <DialogTitle
                  id='confirm-delete-title'>{`Are you sure you want to delete ${values.party_name}?`}</DialogTitle>
                <DialogContent>
