...
export const useShoppingActions = () => {
	...
	const editShoppingItem = useCallback(
		(updatedItem) => {
			...
			axios
				.put(`/parties/${updatedItem.party_id}/shopping/${updatedItem.id}`, updatedItem)
				.then((res) => console.log(res.data))
				.catch((err) => console.log(err));
		},
		[ dispatch ],
	...
	return { fetchShoppingItem, fetchShoppingList, addShoppingItem, editShoppingItem, deleteShoppingItem };
};
